...
class Application(Base):
    ...
    last_ai_error: Mapped[str] = mapped_column(Text, nullable=True)
    last_ai_rerun_at: Mapped[datetime] = mapped_column(DateTime, nullable=True)
    last_ai_attempt_status: Mapped[str] = mapped_column(String(50), nullable=True)
